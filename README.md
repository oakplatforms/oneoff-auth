...
oak-auth contains authentication and authorization Lambda functions for the TCGX platform. This repo is designed for modular, serverless deployment of auth-related services (e.g., custom authorizer, guest token, and future auth lambdas).
